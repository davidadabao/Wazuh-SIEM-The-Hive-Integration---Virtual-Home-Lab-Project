...
Lab Requirements:
1. VirtualBox installed with Wazuh SIEM
2. TheHive setup with Docker and Docker Compose

### 1. Install Python & PIP on your Wazuh server
...
### 2. Install The Hive Python module using PIP
...
### 3. Creating the custom integration script
...
```
### 4. Setting up permissions and ownership*** <br>
...
…
  <integration>
    ...
    <api_key>Ic/t/rZoGwMS0RKa97s0m+G7J57dbGKQ</api_key>
...
Once complete, we need to restart Wazuh Manager:
